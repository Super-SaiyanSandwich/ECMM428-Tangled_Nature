...
const double muDormant = 0.01;    // Scaling factor of dormant individual's pressure on resources ²
...
const int INITIAL_POPULATION = 50;      // Initial number of individuals in the ecology
...
// Determines whether an individual goes dormant or not based on current knowledge.
